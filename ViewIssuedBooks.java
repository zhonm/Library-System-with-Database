...
// Class to display the issued books in a table format
public class ViewIssuedBooks extends JFrame {
    ...
    // Table to display the issued book data
    ...
    public ViewIssuedBooks() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(ViewIssuedBooks.class.getResource("/images/hiclipart.com (1).png")));
        ...
        try{
            ...
            // Preparing SQL statement to fetch all issued books
